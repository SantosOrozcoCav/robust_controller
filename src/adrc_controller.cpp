...
VectorXf x3g(6);			//-------Estimated disturbances
...
void disturbances_callback(const std_msgs::Float32MultiArray disturbances_msg);
...
{
	/*------ROS Setup-------*/
	ros::init(argc, argv,"adrc_controller");
	ros::NodeHandle nh;
